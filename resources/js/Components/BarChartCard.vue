<template>
    <div class="rounded-md shadow bg-white">
        <div class="py-4 px-6">
            <div class="pb-5 text-xl">Programation statistics</div>
            <ChartButton
            ...
            ></ChartButton>
            <BarChart :chart-data="chartData" :chart-labels="chartLabels"></BarChart>
        </div>
    </div>
</template>
...
import ChartButton from "@/Components/Icons/ChartButton.vue";
import {ref} from "vue";
