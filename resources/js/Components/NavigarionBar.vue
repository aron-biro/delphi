<template>
    <div class="w-1/6 h-screen bg-white shadow-md min-w-[210px] pl-6 pt-6 flex flex-col fixed ">
        ...
        <div class="flex-grow">
            <div class="flex flex-col items-start">
                <div class="flex mt-4 space-x-4">
                    <Home></Home>
                    <a href="/dashboard" @click="setActiveButton('general')">General</a></div>
                <div class="flex mt-3 space-x-4">
                    <Calendar stroke-color="#667085"></Calendar>
                    <a href="/dashboard" @click="setActiveButton('programations')">Programations</a></div>
                <div class="flex mt-3 space-x-4">
                    <Patients></Patients>
                    <a href="/dashboard" @click="setActiveButton('patients')">Patients</a></div>
                <div class="flex mt-3 space-x-4">
                    <Stethoscope stroke-color="#667085"></Stethoscope>
                    <a href="/dashboard" @click="setActiveButton('stethoscpe')">Services</a></div>
                <div class="flex mt-3 space-x-4">
                    <Doctor></Doctor>
                    <a href="/dashboard" @click="setActiveButton('doctor')">Doctors</a></div>
                <div class="flex mt-3 space-x-4">
                    <Statistics></Statistics>
                    <a href="/dashboard" @click="setActiveButton('statistics')">Statistics</a></div>
            </div>
        </div>
        <div class="flex items-center mb-4 space-x-4">
            <Settings></Settings>
            <a href="/settings" @click="setActiveButton('general')">Settings</a></div>
